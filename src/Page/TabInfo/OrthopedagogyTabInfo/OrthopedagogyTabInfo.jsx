...
const OrthopedagogyTabInfo = ({ Orthopedagogy }) => {
    console.log(Orthopedagogy);
    return (
        <div>
            {
                Orthopedagogy?.map(OrthopedagogyData => <div key={OrthopedagogyData._id}>
                    <div className='grid grid-cols-1 md:grid-cols-1 lg:grid-cols-2 gap-6'>
                        <div>
                            <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2'>
                                <div>
                                    <h2 className='text-xl font-bold'>{OrthopedagogyData?.Orthopedagogy}</h2>
                                    <p className='w-10 h-1 bg-black'></p>

                                    <p className='pt-5'>Experience: <span className='text-[#4073D1]'>{OrthopedagogyData?.Orthopedagogy_exprience}</span></p>
                                    <p className='pt-5'>  <span className='text-[#4073D1] flex items-center gap-2'>
                                        <FaLocationArrow className='text-xl'></FaLocationArrow>
                                        {OrthopedagogyData?.Orthopedagogy_location}
                                    </span></p>
                                </div>
                        ...
                        <div className=' '>
                            ...
                            <img className='w-full rounded-md h-[450px] bg-cover' src={OrthopedagogyData?.Orthopedagogy_doctor_image} alt="" />
                        </div>
...
export default OrthopedagogyTabInfo;